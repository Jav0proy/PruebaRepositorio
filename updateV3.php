                ...
                <form action="editar.php" method="POST">
                    ...
                    function calcularConsumo() {
                        ...
                        for(var i =0; i < contenido.length; i++){
                           ...
                           document.getElementById("consumo_anterior_"+id_consumo).value =valorAbsolutoAnterior;
                           document.getElementById("consumo_actual_"+id_consumo).value =valorAbsoluto;
                        }
