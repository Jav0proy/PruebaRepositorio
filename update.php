                    ...
                    <table class="tabla">
                        ...
                        <tbody class="container">
                            <div class="contenido">
                                <tr>
                                    <th>
                                        <input class="contenido" name="contenido_id_consumo" type="text" readonly
                                            value="<?php echo $row['id_consumo'] ?>">
                                    </th>
                                    <!--<th><input name="placa" type="text" value="<?php echo $row['eqtrans_placa'] ?>" ></th>-->
                                    <th><input class="contenido" name="consumo_anterior" id="contenido_anterior"
                                            type="text" readonly value="<?php echo $row['consumo_saldo_anterior'] ?>">
                                    </th>
                                    <th><input class="contenido" name="consumo_importe" id="contenido_importe"
                                            type="text" onchange="calcularConsumo()"
                                            value="<?php echo $row['consumo_importe'] ?>"></th>
                                    <th><input class="contenido" name="consumo_saldo" id="contenido_saldo" type="text"
                                            readonly value="<?php if($row['consumo_saldo_actual']=== null)
                    echo "0.00";
                else 
                echo $row['consumo_saldo_actual'] ?>"></th>
                                    <th>
                                        <input type="hidden" name="consumo" value="<?php echo $row['id_consumo']?>">
                                        <input class="form-control" type="submit" onclick="location.reload()"
                                            value="Guardar">
                        ...
                        <tbody>
                            <div class="consumo">
                                <tr><?php while($row= mysqli_fetch_array($query)):?>
                                    <th><input class="consumo" name="consumo" type="text" readonly
                                            value="<?php echo $row['id_consumo'] ?>"></th>
                                    <!--<th><input name="placa" type="text" value="<?php echo $row['eqtrans_placa'] ?>" ></th>-->
                                    <th><input class="consumo" name="consumo_anterior_nuevo" readonly type="text"
                                            id="consumo_anterior_nuevo"
                                            value="<?php echo $row['consumo_saldo_anterior'] ?>"></th>
                                    <th><input class="consumo" name="consumo_importe_nuevo" type="text"
                                            id="consumo_importe_nuevo" value="<?php echo $row['consumo_importe'] ?>">
                                    </th>
                                    <th><input class="consumo" name="consumo_actual_nuevo" type="text" readonly
                                            id="consumo_actual_nuevo" value="<?php if($row['consumo_saldo_actual']=== null)
                    echo "0.00";
                else
                echo $row['consumo_saldo_actual']?>"></th>
                    ...
                    function calcularConsumo() {
                        ...
                        */
                        ...
                        consumos.forEach((elemento, index) => {
                            ...
                            let nuevoActualNuevo = (consumo_anterior_nuevo - consumo_importe_nuevo).toFixed(2);

                            alert(consumo_anterior_nuevo +" " + nuevoAnteriorConsumo + " " + nuevoImporteNuevo + " " + nuevoActualNuevo +" " + importe +" ");
                            console.log(parseFloat(consumo_anterior_nuevo));
                            console.log(parseFloat(nuevoAnteriorConsumo));
                            console.log(parseFloat(nuevoImporteNuevo));
